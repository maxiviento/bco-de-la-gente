...
{
    public class SintysGrupoUnicoPlanoResultado : ICloneable
    {
        ...
        public int GF_Des_Cant_Cuotas { get; set; }
        public int GF_Des_Cant_Liq { get; set; }
        public int GF_Des_Periodo { get; set; }
        public object Clone()
        {
