...
@Component({
  selector: 'bge-consultar-detalle-linea',
  templateUrl: './consulta-detalle-linea.component.html',
  styleUrls: ['./consulta-detalle-linea.component.scss']
})

export class ConsultaDetalleLineaComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute,
    ...
    this.titleService.setTitle('Ver detalle de línea ' + TituloBanco.TITULO);
  }
